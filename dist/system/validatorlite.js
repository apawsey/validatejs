...
System.register(['./validation-ruleset', './validation-rule'], function (_export, _context) {
  var ValidationRuleset, ValidationRule, ValidatorLite;
      ...
      _export('ValidatorLite', ValidatorLite = function (_ValidationRuleset) {
        ...
        ValidatorLite.prototype.importRuleset = function importRuleset(ruleset) {
          ...
          ruleset.forEach(function (rule) {
            _this2.addRule(rule.key, new ValidationRule(rule.value.name, JSON.parse(JSON.stringify(rule.value.config))));
          });
        };
